...
public final class Constants {
    ...
    public static final class RobotConstants {
        public static final double robotOverallLength = Units.inchesToMeters(27.0);
        public static final double robotOverallWidth = Units.inchesToMeters(32.0);
    }
    ...
    public static final class ShooterConstants {
       public static final int FEEDER_MOTOR_ID = 14;
        ...
        public static final double INTAKING_FEEDER_RPM = 7000;
        public static final double INTAKING_LAUNCHER_RPM = -5500;
