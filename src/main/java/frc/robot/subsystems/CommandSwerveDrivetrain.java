...
public class CommandSwerveDrivetrain
  ...
  public void periodic() {
     ...
     * perspective in case the robot code restarts mid-match. Otherwise, only
     * check and apply the operator perspective if the DS is disabled. This
     * ensures driving behavior doesn't change until an explicit disable event
