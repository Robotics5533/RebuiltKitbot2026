...
public class CommandSwerveDrivetrain
  ...
  private final SwerveRequest
      .SysIdSwerveTranslation m_translationCharacterization =
  ...
  /**
   * Adds a vision measurement to the Kalman Filter. This will correct the
   * odometry pose estimate while still accounting for measurement noise. <p>
   ...
   *     measurement in the form [x, y, theta]ᵀ, with units in meters and
   *     radians.
   */
  @Override
  public void addVisionMeasurement(Pose2d visionRobotPoseMeters,
