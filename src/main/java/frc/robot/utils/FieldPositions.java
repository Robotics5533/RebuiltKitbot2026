...
public final class FieldPositions {
  ...
  private static final StructSubscriber<Pose2d> blueBumpLeft2dSub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "BlueBumpLeft", Pose2d.struct)
          .subscribe(Constants.FieldConstants.blueBumpLeftPose);

  private static final StructSubscriber<Pose2d> blueBumpRight2dSub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "BlueBumpRight", Pose2d.struct)
          .subscribe(Constants.FieldConstants.blueBumpRightPose);

  private static final StructSubscriber<Pose2d> redBumpLeft2dSub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "RedBumpLeft", Pose2d.struct)
          .subscribe(Constants.FieldConstants.redBumpLeftPose);

  private static final StructSubscriber<Pose2d> redBumpRight2dSub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "RedBumpRight", Pose2d.struct)
  ...
  private static final StructPublisher<Pose2d> blueBumpLeft2dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "BlueBumpLeft", Pose2d.struct).publish();

  private static final StructPublisher<Pose2d> blueBumpRight2dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "BlueBumpRight", Pose2d.struct).publish();

  private static final StructPublisher<Pose2d> redBumpLeft2dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "RedBumpLeft", Pose2d.struct).publish();

  private static final StructPublisher<Pose2d> redBumpRight2dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT2D + "RedBumpRight", Pose2d.struct).publish();
  ...
  private static final StructPublisher<Pose3d> blueBumpLeft3dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT3D + "BlueBumpLeft", Pose3d.struct).publish();

  private static final StructPublisher<Pose3d> blueBumpRight3dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT3D + "BlueBumpRight", Pose3d.struct).publish();

  private static final StructPublisher<Pose3d> redBumpLeft3dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT3D + "RedBumpLeft", Pose3d.struct).publish();

  private static final StructPublisher<Pose3d> redBumpRight3dPub =
      NetworkTableInstance.getDefault().getStructTopic(ROOT3D + "RedBumpRight", Pose3d.struct).publish();
  ...
  public static Pose2d getBlueHubPose() { return blueHub2dSub.get(); }
  public static Pose2d getRedHubPose() { return redHub2dSub.get(); }

  public static Pose2d getBlueTowerRightPose() { return blueTowerRight2dSub.get(); }
  public static Pose2d getRedTowerRightPose() { return redTowerRight2dSub.get(); }

  public static Pose2d getBlueBumpLeftPose() { return blueBumpLeft2dSub.get(); }
  public static Pose2d getBlueBumpRightPose() { return blueBumpRight2dSub.get(); }

  public static Pose2d getRedBumpLeftPose() { return redBumpLeft2dSub.get(); }
  public static Pose2d getRedBumpRightPose() { return redBumpRight2dSub.get(); }
}
