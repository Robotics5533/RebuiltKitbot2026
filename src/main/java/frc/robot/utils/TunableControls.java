 ...
 *
 * <p>Uses AdvantageKit's {@link LoggedTunableNumber} for runtime tuning of control.
 */
public class TunableControls {
    ...
    public static class ControlConstants {
        ...
        /**
         * Sets the trapezoidal motion profile parameters. Will also set the controller to be profiled.
         *
         ...
         *
         * @param profiled whether the controller is profiled. Automatically set to true when
         *     {@link #withProfile(double, double)} is called.
         * @return this ControlConstants object for chaining
         */
        ...
        /**
         * Sets the controller to be continuous over the given input range. Primarily used for angular control. (e.g. 0
         * and 359 degrees should be considered adjacent)
         *
    ...
    /**
     * Wrapper around a set of control constants that exposes them as {@link LoggedTunableNumber}s for runtime tuning
     * and logging.
     */
    public static class TunableControlConstants {
        ...
        /**
         * Creates a new TunableControlConstants object, initializing the tunable numbers with the values from the given
         * {@link ControlConstants}.
         *
         * @param key base NetworkTables key for the {@link LoggedTunableNumber}s. Should <i>not</i> end with a slash.
        ...
        /**
         * Returns an array of all {@link LoggedTunableNumber}s in this TunableControlConstants.
         *
         * @return array of all LoggedTunableNumbers in the order of: kP, kI, kD, tolerance, velTolerance, iZone, iMin,
         *     iMax, kV, kA, kS, kG, maxVel, maxAcc
         */
        ...
        /**
         * Creates a new {@link PIDController} (not {@link TunablePIDController}) with the configured constants.
         *
        ...
        /**
         * Creates a new {@link ProfiledPIDController} (not {@link TunableProfiledController}) with the configured
         * constants.
         *
         * @see {@link TunableProfiledController} for creating a tunable profiled PID controller.
         */
        public ProfiledPIDController getProfiledPIDController() {
         ...
         * Creates a new {@link ElevatorFeedforward} with the configured constants.
         *
         * <p>Note: This is not necessary when using a {@link TunableProfiledController}.
         */
        public ElevatorFeedforward getElevatorFeedforward() {
    ...
    /**
     * Wrapper around WPILib's {@link PIDController} that updates the controller with runtime-tunable parameters
     * provided by a {@link TunableControlConstants}.
     *
     * <p><i>Note: For motion profiling, use {@link TunableProfiledController}.</i>
     */
    public static class TunablePIDController {
        ...
        /**
         * Creates a new TunablePIDController with the given {@link TunableControlConstants}.
         *
         * @param tunableParams The {@link TunableControlConstants} to configure this controller.
         */
        ...
        /**
         * Returns the {@link TunableControlConstants} used to configure this controller.
         *
        ...
        /** Updates the {@link PIDController}'s parameters from the {@link TunableControlConstants}. */
    ...
    /**
     * Wrapper around WPILib's {@link ProfiledPIDController} and that configures the controller using runtime-tunable
     * values provided by a {@link TunableControlConstants}. It also includes feedforward control (defined by kS, kV,
     * kA, kG).
     *
     * <p><i>Note: For non-motion-profiled control, use {@link TunablePIDController}.</i>
     */
    public static class TunableProfiledController {
        ...
        /**
         * Creates a new TunableProfiledController with the given {@link TunableControlConstants}.
         *
         * @param tunableParams The {@link TunableControlConstants} to configure this controller.
         */
        ...
        /** Updates the controller's parameters based on the current values in the {@link TunableControlConstants}. */
        public void updateParams() {
        ...
        /**
         * Calculates the feedforward output based on the current setpoint and kS, kG, kV, and kA.
         *
